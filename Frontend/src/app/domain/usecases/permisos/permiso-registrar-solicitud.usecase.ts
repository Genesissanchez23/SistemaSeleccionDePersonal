...
/**
    * Caso de uso concreto para registrar una nueva solicitud de permiso.
...
export class PermisoRegistrarSolicitudUsecase implements UseCase<PermisoSolicitudModel, ResponseModel> {
    ...
    /**
        ...
        * Invoca el método `registrarSolicitudPermiso` del PermisoGateway para registrar una nueva solicitud de permiso.
        *
        * @param {PermisoSolicitudModel} params - Datos de la solicitud de permiso que se desea registrar.
